...
public class UserDaoImpl extends BaseDaoImpl<User> implements UserDao{
	...
	@Override
	public User getUserTypeById(int curUserId) {
		String queryString = "FROM User u WHERE u.id = ?";
		return findOne(queryString, curUserId);
	}

	@Override
	public List<User> listFindUser(int did, int type) {
		String queryString = "FROM User u WHERE u.office.id=? and u.role.id=?";
		return findList(queryString, did, type);
	}
