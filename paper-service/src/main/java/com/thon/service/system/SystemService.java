...
public class SystemService{
	...
	public List<User> findList(int officeId,int type){
		return userDao.listFindUser(officeId, type);
	}
	...
	public String getUserTypeById(int curUserId) {
		User user = userDao.getUserTypeById(curUserId);
		return user.getRole().getEnname();
	}
}