...
//            }
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {  
		...
		if (user != null || user.getRole() == null) {
			...
			if ("teacher".equals(user.getRole().getEnname())) {
				info.addStringPermission("tch:menu:edit");
			}
			if ("student".equals(user.getRole().getEnname())) {
				info.addStringPermission("std:menu:edit");
			}
