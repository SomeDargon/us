      ...
      <%--<div class="panel-body" style="min-height:450px;">--%>
		<form id="forget-form" class="form-horizontal" action="${ctx}/forget" method="post">
			...
			<div class="form-group">
		     <label class="col-lg-offset-3 col-lg-1 control-label" for="email"><fmt:message key="forget.email" /></label>
		     <div class="col-lg-4">
		     	<input class="form-control required" type="email" id="email" name="email"  autocomplete="on" />
		     </div>
		    </div>
		    <div class="form-group">
