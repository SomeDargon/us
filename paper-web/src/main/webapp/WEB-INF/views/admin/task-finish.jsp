...
<form class="form-inline well" role="form" id="search-form">
    ...
    <a href="${ctx }/admin/task/finish" class="btn btn-default btn-sm">刷新</a>
</form>
    ...
    <table id="dict-table" class="table table-bordered table-condensed table-hover">
        ...
        <tr>
            ...
            <shiro:hasPermission name="sys:menu:edit">
                <td>
                    <a class="btn-link" href="${ctx}/admin/task/process/deal?id={{ value.id }}">查看</a>
                </td>
            </shiro:hasPermission>
        </tr>
        {{/each}}
...
<script type="text/javascript">
    <c:if test="${env == 'pro' }">
    requirejs(['${ctx}/assets/js/app/admin/task-finish-page.js']);
    </c:if>
    <c:if test="${env != 'pro' }">
    requirejs(['${ctx}/assets/js/app/admin/task-finish-page.js']);
    </c:if>
