...
<div class="col-md-6 col-lg-8 col-xs-12">
	...
	<form id="avatar-form" class="form-horizontal" style="margin-top: 20px;">
		...
		<div class="form-group">
			<label for="avatar" class="col-lg-4 col-md-4 col-sm-2 col-xs-12 control-label">预览</label>
			<div class="col-sm-10 col-md-8 col-lg-6 col-xs-12">
				<input type="hidden" id="avatar" name="avatar" >
			    <div id="file-preview">
			    	<img class="img-thumbnail" src="${user.avatarUrl }" style="height:200px;">
			    </div>
		    </div>
		</div>
		<div class="form-group">
			<label class="col-lg-4 col-md-4 col-sm-2 col-xs-12 control-label"></label>
			<div class="col-sm-10 col-md-8 col-lg-6 col-xs-12">
...
<c:if test="${env == 'pro' }">
		requirejs(["${ctx}/assets/js/app/admin/profile-avatar-page.js"]);
</c:if>
<c:if test="${env != 'pro' }">
		requirejs(["${ctx}/assets/js/app/admin/profile-avatar-page.js"]);
</c:if>
