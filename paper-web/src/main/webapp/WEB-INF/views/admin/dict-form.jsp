...
<form id="dict-form" class="form-horizontal well">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" class="form-control input-sm required" id="name" name="label" value="${dict.label }" title="标签名——必须填写">
		</div>
	</div>
	<div class="form-group">
		<label for="grade" class="col-sm-2 control-label"><span class="text-fill">*</span>数据值</label>
		<div class="col-sm-3">
			<input type="text" class="form-control input-sm required" id="grade" name="value" value="${dict.value }" title="数据值——必须填写">
		</div>
	</div>
	<div class="form-group">
		<label for="type" class="col-sm-2 control-label"><span class="text-fill">*</span>类型</label>
		<div class="col-sm-3">
			<input type="text" class="form-control input-sm required" id="type" name="type" value="${dict.type }" title="类型——必须填写">
		</div>
	</div>
	<div class="form-group">
		<label for="sort" class="col-sm-2 control-label"><span class="text-fill">*</span>排序</label>
		<div class="col-sm-3">
	...
	<div class="form-group">
		<label for="remarks" class="col-sm-2 control-label">附注</label>
		<div class="col-sm-5">
			<textarea id="remarks" name="remarks" rows="7" class="form-control input-sm">${dict.remarks }</textarea>
		</div>
	</div>
