...
<head>
    ...
    <c:if test="${env == 'pro' }">
        <link rel='stylesheet' href="${ctx}/assets/css/my-style.css" rel="stylesheet">
        ...
        <link rel='stylesheet' href="${ctx}/assets/css/paper/schedule.css?v=${ver}" type="text/css" media='screen'/>
        <link rel='stylesheet' href="${ctx}/assets/css/paper/dateSelect.css?v=${ver}" type="text/css" media='screen'/>
        <link rel='stylesheet' href="${ctx}/assets/css/relation/relation.css?v=${ver}" type="text/css" media='screen'/>
        <link rel='stylesheet' href="${ctx}/assets/fonts/awesome/css/font-awesome.css" rel="stylesheet">
        <link rel='stylesheet' href="${ctx}/assets/css/magic-input.min.css" rel="stylesheet">
    </c:if>
